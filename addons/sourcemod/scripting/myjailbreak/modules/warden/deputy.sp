...
void ResetDeputyModel(int client)
{
	if (!gc_bModel.BoolValue || !gc_bModelDeputy.BoolValue)
		return;

	SetEntityModel(client, g_sModelDeputyPathPrevious);
}
