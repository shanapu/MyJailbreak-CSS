...
public void OnPluginStart()
{
	...
	gc_sModelPathZombie = AutoExecConfig_CreateConVar("sm_zombie_model", "models/player/vad36yeti/yeti.mdl", "Path to the model for zombies.");
...
void PrepareDay(bool thisround)
{
	...
	if (thisround) // spawn Terrors to CT Spawn 
	{
		int RandomCT = 0;
		for (int i = 1; i <= MaxClients; i++) if (IsClientInGame(i))
		{
